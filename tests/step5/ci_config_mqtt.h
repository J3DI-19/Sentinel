...
#define TV_TRANSPORT_HTTP   0
#define TV_TRANSPORT_MQTT   1
...
static const char TV_MQTT_CA_PEM[]          = "-----BEGIN CERTIFICATE-----\nCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDER\n-----END CERTIFICATE-----\n";
static const char TV_MQTT_CLIENT_CERT_PEM[] = "-----BEGIN CERTIFICATE-----\nCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDER\n-----END CERTIFICATE-----\n";
static const char TV_MQTT_CLIENT_KEY_PEM[]  = "-----BEGIN PRIVATE KEY-----\nCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDERCIPLACEHOLDER\n-----END PRIVATE KEY-----\n";
